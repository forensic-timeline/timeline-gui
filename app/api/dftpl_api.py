...
# TODO: Add "analyzers.json" to main DFTPL build
# TODO: In dftpl/dftpl.py, modify default to start with every analyzers, then remove depending on selected analyzers
...
def get_analyzers():
    ...
    analyzer_list_path = join(current_app.config['APP_DIR'], 'dftpl_helper', 'analyzers.json')
